...
/**
 * zookeeper连接
 * 使用sessionId和sessionPasswd复用会话
 * Created by Howard Yao on 2018/8/26.
 */
public class ConnectionDemoWithSID implements Watcher{
    ...
    public static void main(String[] args) throws IOException {
        ...
        ZooKeeper zooKeeper = new ZooKeeper(connectString, 5000, new ConnectionDemoWithSID());
        ...
        ZooKeeper zooKeeper2 = new ZooKeeper(connectString, 5000, new ConnectionDemoWithSID(), 123L, "123".getBytes());
        ZooKeeper zooKeeper3 = new ZooKeeper(connectString, 5000, new ConnectionDemoWithSID(), sessionId, sessionPasswd);
